...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return qualifications; });
var projects=[{title:"HTML",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium dolore rerum laborum iure enim sint nemo omnis voluptate exercitationem eius?",image:"./project-1.gif"},{title:"CSS",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium dolore rerum laborum iure enim sint nemo omnis voluptate exercitationem eius?",image:"./project-2.gif"},{title:"React",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium dolore rerum laborum iure enim sint nemo omnis voluptate exercitationem eius?",image:"./project-3.gif"},{title:"Tailwind CSS",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium dolore rerum laborum iure enim sint nemo omnis voluptate exercitationem eius?",image:"./project-4.gif"},{title:"JEST/RTL",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium dolore rerum laborum iure enim sint nemo omnis voluptate exercitationem eius?",image:"./project-4.gif"},{title:"Node.Js",description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium dolore rerum laborum iure enim sint nemo omnis voluptate exercitationem eius?",image:"./project-4.gif"}];var experience=[{quote:"Create unit test cases using Jest and React Testing Library for continuous integration and enhancing software robustness.",Location:"Hyderabad, India",company:"NISC Export Services Pvt. Ltd",from:"February to July 2023"},{quote:"Implemented the front-end for new product website, including custom designs, JavaScript and HTML, CSS, and Bootstrap coding.",Location:"Gurugram, India",company:"Digitup",from:"March 2022 to February 2023"}];var qualifications=[{edu:"Bachelor of Technology in Computer Science and Engineering",Location:"Sonipat, Haryana",university:"DCRUST",from:"2017-2021"}];
...
var _slicedToArray=function(){function sliceIterator(arr,i){var _arr=[];var _n=true;var _d=false;var _e=undefined;try{for(var _i=arr[Symbol.iterator](),_s;!(_n=(_s=_i.next()).done);_n=true){_arr.push(_s.value);if(i&&_arr.length===i)break;}}catch(err){_d=true;_e=err;}finally{try{if(!_n&&_i["return"])_i["return"]();}finally{if(_d)throw _e;}}return _arr;}return function(arr,i){if(Array.isArray(arr)){return arr;}else if(Symbol.iterator in Object(arr)){return sliceIterator(arr,i);}else{throw new TypeError("Invalid attempt to destructure non-iterable instance");}};}();function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else{obj[key]=value;}return obj;}function Contact(){// emailJs starts
// const form = useRef();
// const sendEmail = (e) => {
//   e.preventDefault();
...
function Skills(){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("section",{id:"skills"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"container px-5 py-10 mx-auto"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"text-center mb-20"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",{className:"sm:text-4xl text-3xl font-medium title-font text-white mb-4"},"Education")),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"flex flex-wrap justify-center lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2"},__WEBPACK_IMPORTED_MODULE_1__data__["c" /* qualifications */].map(function(qualifications){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{key:qualifications.edu,className:"p-2 sm:w-1/2 w-full"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"text-center px-8 py-10  z-10 w-full border-4 border-gray-800 bg-gray-900"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h2",{className:"tracking-widest text-sm title-font font-medium text-green-400 mb-1"},qualifications.edu),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",{className:"title-font text-lg font-medium text-white mb-3"},qualifications.from),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"leading-relaxed"}," ",qualifications.university),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"leading-relaxed"}," ",qualifications.Location)));}))));}

/***/ })
/******/ ]);
//# sourceMappingURL=main.09d65055.js.map